...
<title>Listado de Alumnos por Fecha</title>
</head>
<body> 

 <div class="container">
 <h1>Alumno por Fecha</h1>
		 <div class="col-md-23" >  
			  <form id="idFormElimina" action="eliminaModalidad">
			  		<input type="hidden" id="id_elimina" name="id">
			  </form>	
				
		       <form accept-charset="UTF-8"  action="AlumnoListaPorFechaControlador" class="simple_form" id="defaultForm2"  method="post">
					<div class="row">
						<div class="col-md-3">	

...
public class AlumnoModel {
	...
	public List<Alumno> listaAlumnoPorNombre(String x){
		List<Alumno> data = new ArrayList<Alumno>();
	...
	public List<Alumno> listaAlumnoPorApellido(String x){
		List<Alumno> data = new ArrayList<Alumno>();
	...
	public List<Alumno> listaAlumnoPorFecha(Date x, Date y){
		List<Alumno> data = new ArrayList<Alumno>();
